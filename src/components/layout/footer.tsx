...
export function Footer() {
  ...
  return (
    <footer className="bg-[#f0f0f0] px-4 py-8 sm:py-10">
      {/* Main card — taped design */}
      <div className="relative mx-auto max-w-5xl rounded-3xl bg-white px-5 py-8 sm:px-10 sm:py-10">
        {/* Tape decorations */}
        <div className="pointer-events-none absolute -left-8 -top-4 hidden scale-75 md:block">
          {tape}
        </div>
        <div className="pointer-events-none absolute -right-8 -top-4 hidden rotate-90 scale-75 md:block">
          {tape}
        </div>

        <div className="flex flex-col gap-10 md:flex-row md:justify-between">
          {/* Left — Brand */}
          <div className="flex flex-col items-start gap-3 md:max-w-[280px]">
            <Link
              href="/"
              className="font-display text-2xl font-bold tracking-tight text-[#222] uppercase"
            >
              Dusk&Co
            </Link>
            <p className="font-primary text-[14px] font-light leading-relaxed text-[#222]/50">
              A modern expression of self. Born at the intersection of street
              culture and raw intention — from dawn to dusk.
            </p>
          </div>
          ...
          <div className="flex flex-wrap gap-10 sm:gap-16 md:gap-20">
            ...
            <div className="flex flex-col gap-3">
              <h4 className="font-display text-[12px] font-bold tracking-[0.08em] text-[#222]/40 uppercase">
                Shop
              </h4>
              <nav className="flex flex-col gap-2.5">
                <Link
                  href="/collections/frontpage"
                  className="font-primary text-[13px] font-medium text-[#222]/60 transition-colors hover:text-[#222]"
                >
                  All Products
                </Link>
                <Link
            ...
            <div className="flex flex-col gap-3">
              ...
              <nav className="flex flex-col gap-2.5">
                ...
                <span className="font-primary text-[13px] font-medium text-[#222]/30">
                  Blog{" "}
                  <span className="ml-1 inline-flex -rotate-3 rounded-xl bg-[#f0f0f0] px-2.5 py-0.5 text-[10px]">
                    soon
                  </span>
                </span>
              </nav>
            ...
            <div className="flex flex-col gap-3">
              ...
              <nav className="flex flex-col gap-2.5">
                ...
                <Link
                  href="mailto:hello@duskandco.in"
                  className="font-primary text-[13px] font-medium text-[#222]/60 transition-colors hover:text-[#222]"
                >
                  hello@duskandco.in
                </Link>
      ...
      {/* Bottom bar */}
      <div className="mx-auto mt-4 flex max-w-5xl flex-col items-start justify-between gap-4 px-4 sm:flex-row sm:items-center sm:px-8">
        <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:gap-8">
          <p className="font-primary text-[12px] text-[#222]/40">
            &copy;{currentYear} Dusk&Co. All rights reserved.
          </p>
          <div className="flex gap-4">
            <Link
              href="/policies/privacy"
              className="font-primary text-[12px] text-[#222]/40 transition-colors hover:text-[#222]/70"
            >
              Privacy Policy
            </Link>
            <Link
        ...
        <div className="flex items-center gap-4">
          <a
            ...
            aria-label="Dusk&Co on Instagram"
            className="text-[#222]/40 transition-colors hover:text-[#222]/80"
          >
            <InstagramIcon className="h-5 w-5" />
          </a>
          <a
            href="mailto:hello@duskandco.in"
            aria-label="Email Dusk&Co"
            className="text-[#222]/40 transition-colors hover:text-[#222]/80"
          >
